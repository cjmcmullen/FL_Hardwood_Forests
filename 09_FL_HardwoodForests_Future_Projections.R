...
input_base_dir <- "02_rasters/Future_HardwoodLayers"  # Base directory for rasters
model_base_dir <- "04_ENMs"  # Base directory for models
output_base_dir <- "06_FutureProjections"  # Base directory for output projections
...
for (model_dir in model_dirs) {
  ...
  Soil <- list.files("02_rasters/Current_HardwoodLayers", pattern = "*v2.asc", full.names = TRUE)
  Elev <- list.files("02_rasters/Current_HardwoodLayers", pattern = "*elev.asc", full.names = TRUE)
